...
namespace DevIO.Api.V2.Controllers
{
    ...
    [ApiController]
    [DisableCors] //Restringe totalmente o acesso a origens diferentes.
    public class AuthController : MainController
    {
        ...
        private async Task<LoginResponseViewModel> GerarJwt(string email)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Sub, user.Id)); //Usuário.
            claims.Add(new Claim(JwtRegisteredClaimNames.Email, user.Email)); //E-mail.
