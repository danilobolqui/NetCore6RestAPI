...
namespace DevIO.Api.V1.Controllers
{
    ...
    public class ProdutoController : MainController
    {
        ...
        public async Task<ActionResult<ProdutoViewModel>> Adicionar(ProdutoViewModel produtoViewModel)
        {
            ...
            var imagemNome = Guid.NewGuid() + "_" + produtoViewModel.Imagem; //produtoViewModel.Imagem = Nome da imagem
        ...
        [ClaimsAuthorize("Produto", "Adicionar")]
        [HttpPost("[action]")]
        public async Task<ActionResult<ProdutoViewModel>> AdicionarImagemStreamming(ProdutoImagemViewModel produtoImagemViewModel)
        {
            if (!ModelState.IsValid) return CustomResponse(ModelState);
